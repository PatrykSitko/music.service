...
export default ({ color: fill, backgroundColor, ...other }) => {
  return (
    <svg
      ...
      space="preserve"
      style={{ backgroundColor, enableBackground: "new 0 0 397.2 397.2" }}
      {...other}
    >
      <g>
        <g>
          <path
            ...
            d="M317,128.4c-5.6,0-10,4.4-10,10l-1.6,114.8c0,5.6,4.4,10,10,10c5.6,0,10-4.4,10-10l1.6-114.4
          ...
          <path
            ...
            d="M282.2,180.8L235,153.2h-0.4L187.8,126c-0.4,0-0.4-0.4-0.8-0.4c-4.8-2.4-10-2.8-14.8-1.6
